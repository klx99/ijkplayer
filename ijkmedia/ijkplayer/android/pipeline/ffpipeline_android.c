...
typedef struct IJKFF_Pipeline_Opaque {
    ...
    // JsView Added >>>
    bool         (*jsv_video_sync_callback)(void *opaque, jobject mediaCodec, int bufferIndex, int bufferOffset, int bufferSize);
    void          *jsv_video_sync_callback_opaque;
    // JsView Added <<<
...
void ffpipeline_jsv_set_video_sync_callback(IJKFF_Pipeline* pipeline, bool (*callback)(void *opaque), void *opaque)
{
    ...
    pipeline->opaque->jsv_video_sync_callback        = callback;
    pipeline->opaque->jsv_video_sync_callback_opaque = opaque;
}
...
bool ffpipeline_jsv_has_video_sync_callback(IJKFF_Pipeline* pipeline)
{
    ...
    return (pipeline->opaque->jsv_video_sync_callback != NULL);
}
...
bool ffpipeline_jsv_video_sync(IJKFF_Pipeline* pipeline, jobject mediaCodec, int bufferIndex, int bufferOffset, int bufferSize)
{
    ...
    if (!pipeline->opaque->jsv_video_sync_callback)
        return false;

    return pipeline->opaque->jsv_video_sync_callback(pipeline->opaque->jsv_video_sync_callback_opaque,
